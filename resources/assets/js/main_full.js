...
$(document).ready(function () {
    ...
    var swiper = new Swiper('.about-video', {
        navigation: {
            nextEl: '.swiper-button-next',
            prevEl: '.swiper-button-prev',
        },
    });
    var swiper = new Swiper('.about-gallery', {
        navigation: {
            nextEl: '.swiper-button-next',
            prevEl: '.swiper-button-prev',
        },
...
let typedText = $('#typed-text').html();
if (typedText) {
    var typed = new Typed('#typed-text', {
        stringsElement: '#typed-stings',
        typeSpeed: 100,
        startDelay: 0,
        loop: true,
        loopCount: Infinity,
...
var swiper = new Swiper('#mentors-container', {
    pagination: {
...
$('#mentorsControl').carousel({
    interval: false
})
console.log($('#mentorsControl video'))
console.log($('#mentorsControl .fa-play').next())
...
$('#mentorsControl .play').click(function () {
    if(check) {
        $(this).next().trigger('play')
...
$(window).load(function () {
    ...
    $('.point').click(function(){
        $(this).find('.click').fadeIn();
    }).mouseleave(function(){
        $(this).find('.click').fadeOut();
    });


    let homeHeight = $('#home').height();
    if(homeHeight) {
        $('#particles-js').height(homeHeight)
    ...
    let ceoHeight = $('#ceo').innerHeight();
    if (ceoHeight){
        $('#particles-js-ceo').height(ceoHeight)
        particlesJS("particles-js-ceo", {
            "particles": {
                "number": {
                    "value": 80,
                    "density": {
