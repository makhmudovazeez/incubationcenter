@php
    /**
     * @var \App\Entity\Applications\Startup
     */
@endphp
...
@section('title', 'Startups Applications')

@section('content_header')
    <h1 class="m-0 text-dark">Startups Applications</h1>
@stop
                ...
                <div class="card-body">
                    <table id="application" class="table table-bordered table-hover dataTable" role="grid"
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                aria-label="CSS grade: activate to sort column ascending">	Startup
                            </th>
                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                        ...
                        @foreach($applications as $application)
                            <tr role="row" class="odd">
                                ...
                                <td class="text-center d-flex justify-content-center">
                                    <a href="{{route('admin.startups.show', $application->id)}}" class="btn btn-primary"><i
                                            class="fas fa-folder"></i> View</a>
                                    <form method="POST" action="{{ route('admin.startups.destroy', $application->id) }}" class="mr-1">
                                        @csrf
                                        @method('DELETE')
