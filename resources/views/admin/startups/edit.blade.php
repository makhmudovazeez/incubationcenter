                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       name="title" value="{{ old('title', $startup->title) }}">
                            ...
                            <img src="{{$startup->getImagePath('thumbnail')}}" alt="" class="mb-4"><br>

                            <button type="submit" class="btn btn-info"><i class="fas fa-pencil-alt"></i> Update startup</button>
                            <a href="{{route('admin.startup.index')}}" class="btn btn-primary"><i class="fas fa-angle-double-left"></i> Back</a>
                        </div>
                    </div>
                </div>
            </div>
