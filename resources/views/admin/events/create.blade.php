                        ...
                        <div class="tab-content" id="custom-tabs-two-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="ru" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        class="form-control summernote_field  {{ $errors->has('ru_content') ? 'is-invalid' : '' }}"
                                        id="news_content"
                            ...
                            <div class="tab-pane fade" id="uz" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        class="form-control summernote_field  {{ $errors->has('uz_content') ? 'is-invalid' : '' }}"
                                        id="news_content"
                                        aria-describedby="emailHelp"
                            ...
                            <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="contact-tab">
                                ...
                                <div class="form-group">
                                    <label for="news_title">Content (*)</label>
                                    <textarea
                                        class="form-control summernote_field  {{ $errors->has('en_content') ? 'is-invalid' : '' }}"
                                        id="news_content"
                                        aria-describedby="emailHelp"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-success"><i class="fas fa-plus-square"></i> Create
                                Event
                            </button>
